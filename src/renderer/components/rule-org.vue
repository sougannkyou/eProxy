<template>
    <div id="rules_panel">
        ...
        <div class="rules-list">
            <el-button type="primary" :plain="true" icon="plus" @click="eidtRuleStatus = true">
